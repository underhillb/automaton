...
class ObjectTypesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create object_type" do
    assert_difference('ObjectType.count') do
      post object_types_url, params: { object_type: { description: @object_type.description, name: @object_type.name } }
    end
  ...
  test "should update object_type" do
    patch object_type_url(@object_type), params: { object_type: { description: @object_type.description, name: @object_type.name } }
